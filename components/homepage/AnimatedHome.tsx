    ...
    <main className="flex flex-col-reverse items-center justify-between w-full max-w-screen-xl min-h-screen px-4 pb-10 mx-auto pt-28 lg:-pt-28 lg:py-0 lg:flex-row">
      ...
      >
        ...
        <p className="pb-5 text-sm text-justify text-gray-800 md:text-base">
          I&apos;m Daniel Mbedobe, a frontend developer from Ghana specializing
          in fast, accessible, and user-focused web experiences. I also offer
          high-quality data entry and extraction services. Whether you need a
          modern static or dynamic website or help organizing your data,
          I&apos;m here to deliver with creativity and precision. Let&apos;s
