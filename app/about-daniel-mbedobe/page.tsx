  ...
  return (
    <>
      <SEO
        ...
        description="Learn more about Daniel’s journey in web development, data entry, and the technologies he loves."
        keywords="Daniel Mbedobe, web developer, MERN, React, Tailwind, data entry, Ghana"
      />
